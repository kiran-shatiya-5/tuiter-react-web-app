const NavigationSidebar = () => {
  return(`
      <div class="list-group">
        ...
        <a href="../ExploreScreen/index.html" class="list-group-item list-group-item-action active" id="explore"><i class="fa-sharp fa-solid fa-hashtag text-white"></i><h6 class="d-none d-sm-none d-md-none d-lg-none d-xl-inline d-xxl-inline"> Explore</h6></a>
